...
content/scan-report.json  Latest app scan results (built by scan-apps.js)
...
Scans `/Applications`, `/Applications/Setapp`, and `~/Applications`. New entries are pre-filled with category, description, URL, and tags where known. All generated files start with `display: false` — review and enable in TinaCMS.
